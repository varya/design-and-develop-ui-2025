...
## 9 Years in a row
{ .evolution-slide .title-08 .text-08 }

<div className="timeline">
  <div className="timeline__item timeline__item--position-1">
    <div className="timeline__item-name">2016</div>
    <div className="timeline__item-icon timeline__item-icon--car1">
    </div>
  </div>
  <div className="timeline__item timeline__item--position-2">
    <div className="timeline__item-name">2025</div>
    <div className="timeline__item-icon timeline__item-icon--car2">
    </div>
  </div>
</div>

[Component development in CSS](https://varya.me/component-development-css-2016/) @
[varya.me/component-development-css-2016](https://varya.me/component-development-css-2016/)
...
.evolution-slide .timeline {
  justify-content: center;
  gap: 50px;
}

.evolution-slide .timeline__item {
  width: 350px;
  height: 300px;
  line-height: 300px;
  font-size: 6em;
...
.evolution-slide .timeline__item-name {
  top: -20px;
  left: 25px;
  width: 100px;
  background: white;
...
.evolution-slide .timeline__item-icon {
  width: 260px;
  height: 260px;
  margin: 20px;
  display: flex;
...
.evolution-slide .timeline__item-icon--car1 {
  width: 100%;
  height: 100%;
  margin: 0;
  background-image: url(pictures/first-car.png);
  background-size: cover;
  background-position: center;
  background-repeat: no-repeat;
}

.evolution-slide .timeline__item-icon--car2 {
  width: 100%;
  height: 100%;
  margin: 0;
  background-image: url(pictures/last-car.png);
  background-size: cover;
  background-position: center;
  background-repeat: no-repeat;
}

.evolution-slide .timeline__item-icon img {
  width: 100%;
  height: 100%;
  object-fit: contain;
}
...
.evolution-slide strong {
  color: #38bcc2;
}
`}</style>

<!--
This slide highlights that I've been giving this lecture for 9 consecutive years, starting in 2016. It shows the evolution from focusing purely on component development in CSS to now covering the broader ecosystem of design systems and AI integration. The timeline visually represents this journey from 2016 to 2025, emphasizing the continuity and evolution of the content.
-->
